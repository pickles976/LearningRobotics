...
export class InverseKinematics {
    ...
    */
    static new(origin_array, angles_array, axes_array, radii_array, arm_colliders, arm_offsets, world_colliders, world_offsets) {
        const ret = wasm.inversekinematics_new(addHeapObject(origin_array), addHeapObject(angles_array), addHeapObject(axes_array), addHeapObject(radii_array), addHeapObject(arm_colliders), addHeapObject(arm_offsets), addHeapObject(world_colliders), addHeapObject(world_offsets));
