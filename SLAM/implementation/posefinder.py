...
class VisualOdometry():
    def __init__(self):
        self.K, self.d, self.P = self._loadCameraMatrix('calib.json')
    ...
    def pose_from_images(self, img1, img2):
        ...
        q1, q2 = self.get_matches(img1, img2)
    ...
    def get_matches(self, new_img, prev_img):
        """
        ...
        kp1, des1 = self.orb.detectAndCompute(prev_img, None) # old image
        kp2, des2 = self.orb.detectAndCompute(new_img, None) # new image
        # Find matches
    ...
    def get_pose(self, new_image, prev_image):
        """
